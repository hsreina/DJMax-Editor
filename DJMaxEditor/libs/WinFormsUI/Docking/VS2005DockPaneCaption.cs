        ...
        private static string ToolTipClose
        {
            ...
            {    
                if (_toolTipClose == null)
                    _toolTipClose = DJMaxEditor.Resources.DockPaneCaption_ToolTipClose;
        ...
        private static string ToolTipOptions
        {
            get
            {
                if (_toolTipOptions == null)
                    _toolTipOptions = DJMaxEditor.Resources.DockPaneCaption_ToolTipOptions;
        ...
        private static string ToolTipAutoHide
        {
            ...
            {    
                if (_toolTipAutoHide == null)
                    _toolTipAutoHide = DJMaxEditor.Resources.DockPaneCaption_ToolTipAutoHide;
