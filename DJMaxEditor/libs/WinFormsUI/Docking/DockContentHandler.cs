    ...
    public class DockContentHandler : IDisposable, IDockDragSource
    {
        ...
        public DockContentHandler(Form form, GetPersistStringCallback getPersistStringCallback)
        {
            if (!(form is IDockContent))
                throw new ArgumentException(DJMaxEditor.Resources.DockContent_Constructor_InvalidForm, "form");
        ...
        public double AutoHidePortion
        {
            ...
            {
                if (value <= 0)
                    throw(new ArgumentOutOfRangeException(DJMaxEditor.Resources.DockContentHandler_AutoHidePortion_OutOfRange));
        ...
        public DockAreas DockAreas
        {
            ...
            set
            {
                ...
                if (!DockHelper.IsDockStateValid(DockState, value))
                    throw(new InvalidOperationException(DJMaxEditor.Resources.DockContentHandler_DockAreas_InvalidValue));
        ...
        public bool IsFloat
        {
            ...
            set
            {
                ...
                if (visibleState == DockState.Unknown)
                    throw new InvalidOperationException(DJMaxEditor.Resources.DockContentHandler_IsFloat_InvalidValue);
            ...
            set
            {
                ...
                if (value != null)
                {
                    if (value.IsFloat || value.DockPanel != DockPanel)
                        throw new InvalidOperationException(DJMaxEditor.Resources.DockContentHandler_DockPane_InvalidValue);
                }
        ...
        public DockPane FloatPane
        {
            ...
            set
            {
                ...
                {
                    if (!value.IsFloat || value.DockPanel != DockPanel)
                        throw new InvalidOperationException(DJMaxEditor.Resources.DockContentHandler_FloatPane_InvalidValue);
                }
        ...
        public DockState ShowHint
        {
            ...
            {    
                if (!DockHelper.IsDockStateValid(value, DockAreas))
                    throw (new InvalidOperationException(DJMaxEditor.Resources.DockContentHandler_ShowHint_InvalidValue));
        ...
        {
            if (dockPanel == null)
                throw(new ArgumentNullException(DJMaxEditor.Resources.DockContentHandler_Show_NullDockPanel));
        ...
        public void Show(DockPanel dockPanel, DockState dockState)
        {
            ...
            if (dockState == DockState.Unknown || dockState == DockState.Hidden)
                throw(new ArgumentException(DJMaxEditor.Resources.DockContentHandler_Show_InvalidDockState));
        ...
        {
            if (pane == null)
                throw(new ArgumentNullException(DJMaxEditor.Resources.DockContentHandler_Show_NullPane));

            if (beforeContent != null && pane.Contents.IndexOf(beforeContent) == -1)
                throw(new ArgumentException(DJMaxEditor.Resources.DockContentHandler_Show_InvalidBeforeContent));
        ...
        public void Show(DockPane previousPane, DockAlignment alignment, double proportion)
        {
            if (previousPane == null)
                throw(new ArgumentException(DJMaxEditor.Resources.DockContentHandler_Show_InvalidPrevPane));
        ...
        {
            if (panel != DockPanel)
                throw new ArgumentException(DJMaxEditor.Resources.IDockDragSource_DockTo_InvalidPanel, "panel");
