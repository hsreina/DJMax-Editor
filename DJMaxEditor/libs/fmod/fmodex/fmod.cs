...
namespace FMODEX
{
...
#else
        public const string dll    = "./libs/fmod/fmodex";
#endif
    }
    ...
    */
    public enum SYSTEM_CALLBACKTYPE :int
    {
        ...
        MEMORYALLOCATIONFAILED, /* Called directly when a memory allocation fails somewhere in FMODEX. */
    ...
    */
    ...
    {                       
        ...
        public string  debugLogFilename;            /* [in/out] Optional. Specify 0 to ignore. Gives fmod's logging system a path/filename.  Normally the log is placed in the same directory as the executable and called FMODEX.log. When using System::getAdvancedSettings, provide at least 256 bytes of memory to copy into. */
